...
import io.jht.common.validator.group.AddGroup;
import io.jht.common.validator.group.UpdateGroup;
...
public class SysUserController extends AbstractController {
	...
	public R info(){
		...
		// 获取用户所属的角色列表
		List<SysRoleEntity> roleIdList = sysUserRoleService.queryRoleList(user.getUserId());
	...
	public R password(String password, String newPassword){
		...
		//更新密码
		int count = sysUserService.updatePassword(getUserId(), password, newPassword,getUser().getSalt());
		if(count == 0){
